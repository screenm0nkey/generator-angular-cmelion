...
Generator.prototype.createComponentFiles = function createComponentFiles() {
	...
	this.moduleName = _.camelize(targetPath.split('/')[1]);
	this.appTemplate('protractor/test', '../test/e2e/spec' + targetPath);
	this.appTemplate('protractor/page', '../test/e2e/pages' + targetPath + '-page');
};

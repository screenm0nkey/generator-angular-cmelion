...
Generator.prototype.packageFiles = function () {
    ...
    this.template('../../templates/javascript/framework/errorCtrl.js', 'app/pages/error/index/error-controller.js');
    ...
    this.template('../../templates/javascript/spec/navbar.js', 'app/components/components/navbar/navbar.test.js');
    this.template('../../templates/javascript/spec/errorCtrl.js', 'app/pages/error/index/error-controller.test.js');
    this.template('../../templates/javascript/framework/mainCtrl.js', 'app/pages/index/index/index.js');
    this.template('../../templates/javascript/spec/mainCtrl.js', 'app/pages/index/index/index.test.js');
    this.template('../../templates/javascript/framework/mock-api.js', 'app/dev/mock-api.js');
    this.template('../../templates/javascript/framework/state-factory.js', 'app/scripts/framework/state-factory/state-factory.js');
    this.template('../../templates/javascript/spec/state-factory.js', 'app/scripts/framework/state-factory/state-factory.test.js');
    this.template('../../templates/javascript/framework/dasherize.js', 'app/scripts/framework/dasherize/dasherize.js');
    this.template('../../templates/javascript/spec/dasherize.js', 'app/scripts/framework/dasherize/dasherize.test.js');
    this.template('../../templates/javascript/framework/model-factory.js', 'app/scripts/framework/model-factory/model-factory.js');
    this.template('../../templates/javascript/spec/model-factory.js', 'app/scripts/framework/model-factory/model-factory.test.js');
    this.template('../../templates/javascript/framework/offset-filter.js', 'app/scripts/filters/offset/offset.js');
    this.template('../../templates/javascript/spec/offset-filter.js', 'app/scripts/filters/offset/offset.test.js');
};
